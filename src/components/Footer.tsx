      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12">
          <div className="bg-gradient-to-br from-blue-900/20 to-yellow-500/20 p-6 rounded-xl">
            ...
            <p className="text-gray-400 text-sm">
              BioKEA's open-access journal suite reimagines peer review with AI co-reviewers,
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <div className="flex justify-center space-x-6 mb-6">
            <a
              href="https://bsky.app/profile/biokeaai.bsky.social"
            ...
            <a
              href="https://www.linkedin.com/company/107141668"
              className="text-gray-400 hover:text-white"
              target="_blank"
              rel="noopener noreferrer"
            >
